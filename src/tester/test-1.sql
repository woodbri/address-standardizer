...
insert into test_data value (1, 'test-1','
[HOUSE_NUMBER]
NUMBER -> HOUSE -> 0.3
FRACT  -> HOUSE -> 0.2
MIXED  -> HOUSE -> 0.1
...
insert into test_data value (2, 'test-german','
# german.grammar
...
BUILDT -> BLDNG -> 0.7
BUILDT WORD -> BLDNG BLDNG BLDNG -> 0.6
...
NUMBER SLASH NUMBER DOUBLE -> HOUSE HOUSE HOUSE HOUSE -> 0.7
...
'
LEXICON:	lex-germany.txt	GER	de_DE	
